    ...
    <div className="min-h-screen bg-bg">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 pt-24">
        ...
        <Section title="Animal welfare">
          ...
          <p>If at any point you believe your puppy is unwell, stop and contact a local veterinarian in person. Our 24/7 chat support can help you assess whether to proceed or seek immediate care.</p>
